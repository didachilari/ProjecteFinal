...
<div class="container">
    ...
    // Consulta SQL para obtener los productos según el término de búsqueda
    ...
    if ($result->num_rows > 0) {
        echo "<h2>Resultados de búsqueda para: $searchTerm</h2>";
        echo '<div class="row">';
        ...
        echo "<p>No se encontraron productos para: $searchTerm</p>";
    }
