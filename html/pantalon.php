...
<head>
    ...
    <title>Seccion Pantalones</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link"  aria-current="page" href="">Pantalon</a>
          </li>
          <li class="nav-item">
...
//farem un select per a que pugi mostrar el nom del usuari, el nom de la marca de la taula productes i una categoria especifica que es la de 'pantalon'
$sql = "SELECT p.*, u.nom_usuari, m.nom AS nom_marca
    ...
    WHERE categorias LIKE '%Pantalon%'";
