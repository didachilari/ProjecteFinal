    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="./camisa.php">Camisa</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="">Chaquetas</a>
          </li>
          <li class="nav-item">
...
//farem un select per a que pugi mostrar el nom del usuari, el nom de la marca de la taula productes i una categoria especifica que es la de 'chaquetas'
$sql = "SELECT p.*, u.nom_usuari, m.nom AS nom_marca
    ...
    WHERE categorias LIKE '%Abrigo%'";
$result = $conn->query($sql);
?>
<section class="abrigo">
    <div class="margin-top-80-30">
        <div class="container">
          <h2>Seccion Chaquetas</h2>
            <?php if ($result->num_rows > 0) {?>
                <div class="row">
                <!-- amb un foreach recorrerem els productes que siguin de la categoria chaquetas -->
